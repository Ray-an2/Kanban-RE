...
// --- Routes auth (gérées directement par Deno) ---
...
// ============================================================
// Base de données SQLite locale (auth uniquement)
// ============================================================
...
/*
 * BUG CORRIGÉ : proxy.ts utilisait TOMCAT_URL mais la variable
 * définie dans .env s'appelle TOMCAT_BASE_URL.
 * On vérifie sa présence au démarrage pour échouer tôt et clairement.
 */
...
// --- Middleware global ---
app.use(oakCors());
app.use(errorMiddleware);  // doit être avant les routes

// ============================================================
// Routes
// ============================================================

// Auth : inscription, login, validate — gérés par Deno directement
app.use(routeAuth.routes(),          routeAuth.allowedMethods());

// Proxy vers Tomcat (JWT vérifié avant chaque requête)
