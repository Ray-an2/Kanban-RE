...
INSERT INTO t_compte_cpt (cpt_pseudo, cpt_mdp, cpt_role) VALUES
  ('a.martin', '7f3f2b1c5d6e7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2', 'A'),
  ('l.dupont', '9c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1', 'U'),
  ('s.bernard', '1a2b3c4d5e6f708192a3b4c5d6e7f8091a2b3c4d5e6f708192a3b4c5d6e7f8', 'U'),
  ('p.legrand', '0f1e2d3c4b5a69788796a5b4c3d2e1f00112233445566778899aabbccddeeff', 'U');

INSERT INTO t_profil_pfl (pfl_nom, pfl_prenom, pfl_mail, pfl_date, cpt_pseudo) VALUES
  ('Martin', 'Alice', 'alice.martin@acme-consulting.fr', '2026-03-01T09:10:00Z', 'a.martin'),
  ('Dupont', 'Lucas', 'lucas.dupont@acme-consulting.fr', '2026-03-02T10:05:00Z', 'l.dupont'),
  ('Bernard', 'Sophie', 'sophie.bernard@acme-consulting.fr', '2026-03-03T08:45:00Z', 's.bernard'),
  ('Legrand', 'Paul', 'paul.legrand@acme-consulting.fr', '2026-03-04T11:20:00Z', 'p.legrand');
...
INSERT INTO t_role_rol (cpt_pseudo, tab_id, rol_role) VALUES
  ('a.martin', 'tab_roadmap_2026', 'A'),
  ('l.dupont', 'tab_roadmap_2026', 'M'),
  ('s.bernard', 'tab_roadmap_2026', 'M'),
  ('a.martin', 'tab_client_onboarding', 'A'),
  ('p.legrand', 'tab_client_onboarding', 'M'),
  ('s.bernard', 'tab_client_onboarding', 'M');
...
INSERT INTO t_carte_car (
  ...
  car_dateCreation, car_dateDebut, car_dateFin, car_couverture, lis_id
) VALUES
  ('car_spec_api', 'Spécification API v2', 'Rédiger les spécifications fonctionnelles et techniques.', '0', '0', 2,
   '2026-03-10T10:00:00Z', '2026-03-10T11:00:00Z', NULL, NULL, 'lis_rm_backlog'),
  ('car_design_system', 'Design system', 'Définir les composants UI réutilisables.', '0', '0', 3,
   '2026-03-10T10:30:00Z', '2026-03-11T09:00:00Z', NULL, NULL, 'lis_rm_en_cours'),
  ('car_release_notes', 'Release notes Q1', 'Préparer les notes de version pour le Q1.', '0', '1', 1,
   '2026-03-05T08:20:00Z', '2026-03-06T09:00:00Z', '2026-03-07T16:00:00Z', NULL, 'lis_rm_termine'),
  ('car_kickoff', 'Réunion de lancement', 'Organiser la réunion de lancement du client.', '0', '0', 2,
   '2026-03-09T15:00:00Z', '2026-03-10T09:30:00Z', NULL, NULL, 'lis_onb_a_faire'),
  ('car_access_setup', 'Création des accès', 'Créer les comptes et accès aux outils.', '0', '0', 3,
   '2026-03-09T16:10:00Z', '2026-03-11T09:30:00Z', NULL, NULL, 'lis_onb_en_cours'),
  ('car_training', 'Session de formation', 'Préparer le support et planifier la formation.', '0', '1', 1,
...
INSERT INTO t_membre_mem (cpt_pseudo, car_id, mem_date) VALUES
  ('a.martin', 'car_spec_api', '2026-03-10T10:05:00Z'),
  ('l.dupont', 'car_design_system', '2026-03-11T09:05:00Z'),
  ('s.bernard', 'car_access_setup', '2026-03-11T10:00:00Z'),
  ('p.legrand', 'car_kickoff', '2026-03-10T09:40:00Z');

INSERT INTO t_notification_not (not_id, not_titre, not_date, not_lien, cpt_pseudo) VALUES
  ('not_001', 'Nouvelle carte assignée', '2026-03-11T10:01:00Z', '/tableau/tab_client_onboarding', 's.bernard'),
  ('not_002', 'Carte terminée', '2026-03-07T16:05:00Z', '/tableau/tab_roadmap_2026', 'a.martin');
